...
class MainMenu:
    def __init__(self, surface, create_overworld):
        ...
        self.button_two_rect = pygame.Rect(screen_width/2 - 200, 528, 170, 142)
        self.button_two = pygame.image.load('graphics/play_but.png').convert_alpha()
        self.button_three_rect = pygame.Rect(screen_width/2 + 30, 528, 170, 142)
    ...
    def run(self):
        ...
        self.create_button(self.button_two, (screen_width/2 - 200, 528))
        self.create_button(self.button_three, (screen_width/2 + 30, 528))
        self.is_pressed()

...
class MainMenu:
    def __init__(self, surface, create_overworld):
        ...
        self.button_one_rect = pygame.Rect(screen_width/2 - 310, 528, 170, 142)
        self.button_one = pygame.image.load('graphics/play_but.png').convert_alpha()
        self.button_two_rect = pygame.Rect(screen_width/2 - 85, 528, 170, 142)
        self.button_two = pygame.image.load('graphics/cred_but.png').convert_alpha()
        self.button_three_rect = pygame.Rect(screen_width/2 + 140, 528, 170, 142)
    ...
    def is_pressed(self):
        ...
        if self.button_one_rect.colliderect(mouse_pos_rect) and mouse_presses[0]:
    ...
    def run(self):
        ...
        self.create_button(self.button_one, (screen_width/2 - 310, 528))
